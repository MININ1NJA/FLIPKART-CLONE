...
const Connection = async (username, password) => {
    ...
    const URL = `mongodb://${username}:${password}@ac-ise9br0-shard-00-00.d1ldgda.mongodb.net:27017,ac-ise9br0-shard-00-01.d1ldgda.mongodb.net:27017,ac-ise9br0-shard-00-02.d1ldgda.mongodb.net:27017/ECOMMERCE?ssl=true&replicaSet=atlas-98hgw4-shard-0&authSource=admin&retryWrites=true&w=majority`;
    try {
